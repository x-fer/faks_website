...
const eventStyles = {
  ...
  keynote:
    "bg-keynote-fill border-keynote-stroke inset-shadow-keynote-stroke/15",
};
...
export default function PredavaciDeatilsCard(props: Props) {
  ...
  return (
    <div className="flex flex-col gap-10 lg:flex-row lg:gap-20">
      <div className="mx-auto flex flex-col gap-5 lg:mx-0">
        ...
        <p className="font-nuito-sans text-center text-xl lg:text-2xl font-semibold text-[#D2D2D2] italic">
          {talkInfo.speaker ? talkInfo.speaker.name : "UNKNOWN"}
        </p>
      </div>
        ...
        <div className="font-open-sans text-white-smoke w-full space-y-10 rounded-xl border-2 border-[#4A4A4A] bg-black px-10 py-8 lg:px-16 lg:py-8">
          {talkInfo.speaker && (
            <div className="space-y-3">
              ...
              <p className="font-nuito-sans text-lg text-[#C7C7C7] italic">
                {talkInfo.speaker?.biography}
              </p>
            </div>
          )}
