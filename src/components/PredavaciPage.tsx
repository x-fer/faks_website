...
const data = [
  {
    profile: "/speakers/speaker1.svg",
    name: "Igor Jakovic",
    type: "tech",
    title: "The Art of Bonsai: How to Build a Cyber Security Expert?",
    about:
